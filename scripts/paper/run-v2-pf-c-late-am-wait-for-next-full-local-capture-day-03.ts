...
const ticket = 'V2-PF-C-LATE-AM-PAPER-OBSERVATION-WAIT-FOR-NEXT-FULL-LOCAL-CAPTURE-DAY-03';
const slug = 'v2-pf-c-late-am-paper-observation-wait-for-next-full-local-capture-day-03';
const priorReportPath = 'artifacts/paper-observation/v2-pf-c-late-am-paper-observation-wait-for-next-full-local-capture-day-02/wait-for-next-full-local-capture-day-report.json';
...
const report: Record<string, Json> = { ticket, substrate_sha: '2a56d45107dafc9bf7a06de5a6ea3cedad9c1bbd', determination, wait_status: waitStatus, scans, authority_caveat: authorityCaveat };
...
const backlogRow = `${ticket},P1,1.0,V2-PF-C-LATE-AM-PAPER-OBSERVATION-WAIT-FOR-NEXT-FULL-LOCAL-CAPTURE-DAY-02,Refresh wait state for the next post-2026-06-04 full local RTH capture day before additional paper-observation accrual without runtime markers or authority,new_cycle4_v2_research_substrate`;
