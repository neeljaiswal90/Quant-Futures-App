...
Full DATA-01B still requires the MBO consumer implementation, DATA-03 authority FSM,
DATA-04 feature engine, SIM-02/SIM-03 calibration, and provider-internal replay evidence.
...
Not validated:
- MBO consumer implementation and provider-internal replay evidence.
...
Full DATA-01 closure still requires MBO consumer implementation, DATA-03/DATA-04 evidence,
