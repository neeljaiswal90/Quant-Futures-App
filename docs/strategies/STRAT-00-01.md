...
`ORCH-02` must not treat a registry entry as executable until the entry is promoted by its extraction ticket. As of `STRAT-05`, all four V1 deterministic strategies are active.
