...
function artifactTrade(
  ...
  return Object.freeze({
    ...
    time_stop_at_deadline_extension: trade.time_stop_at_deadline_extension,
    exits: trade.exits.map((exit) => Object.freeze({
      exit_ts_ns: exit.exit_ts_ns.toString(),
      exit_quantity: exit.exit_quantity,
