...
export const STRATEGY_SYNTHETIC_FIXTURES = {
  ...
  regime_shock_reversion_short_v3: {
    fixture_id: 'fixture_regime_shock_reversion_short_v3',
    strategy_id: 'regime_shock_reversion_short_v3',
    description: 'High-regime upside shock above VWAP eligible for the inactive v3 VIX-gated reversion successor.',
    expected_direction: 'short',
    expected_gate_state: 'armed',
    expected_reason_fragments: ['vix_pct', 'regime_high', 'signed_shock_vwap', 'armed'],
    snapshot: makeSnapshot({
      fixtureId: 'fixture_regime_shock_reversion_short_v3',
      sourceEventId: 'source-bar-regime-shock-reversion-short-v3',
      createdOffsetNs: 17n * 60_000_000_000n,
      direction: 'short',
      bidPx: 18614.875,
      askPx: 18615.125,
      lastTradePrice: 18615,
      ...
      regimeLabel: 'high',
      context: {
        vix_prior_close_percentile: 0.92,
        session_vwap: 18600,
        signed_shock_vwap: {
          value: 2.5,
          anchor_type: 'vwap',
