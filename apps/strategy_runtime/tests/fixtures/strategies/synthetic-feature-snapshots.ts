...
export const STRATEGY_SYNTHETIC_FIXTURES = {
  ...
  opening_range_box_breakout_long: {
    ...
    description: 'Price clears the 10:00 box high by the confirmation buffer within the chase limit.',
    expected_direction: 'long',
    expected_gate_state: 'armed',
    expected_reason_fragments: ['armed', 'mode_breakout', 'box_breakout_distance_ticks'],
    snapshot: makeSnapshot({
      ...
      context: {
        ten_am_box_high: 18600,
        ten_am_box_low: 18595,
        ten_am_box_ready: true,
      },
    }),
  },
  opening_range_box_breakout_short: {
    fixture_id: 'fixture_opening_range_box_breakout_short',
    strategy_id: 'opening_range_box_breakout_short',
    description: 'Price breaks the 10:00 box low by the confirmation buffer within the chase limit.',
    expected_direction: 'short',
    expected_gate_state: 'armed',
    expected_reason_fragments: ['armed', 'mode_breakout', 'box_breakout_distance_ticks'],
    snapshot: makeSnapshot({
      fixtureId: 'fixture_opening_range_box_breakout_short',
      sourceEventId: 'source-bar-opening-range-box-breakout-short',
      createdOffsetNs: 18n * 60_000_000_000n,
      direction: 'short',
      bidPx: 18593.875,
      askPx: 18594.125,
      lastTradePrice: 18594,
      barsStartClose: 18604,
      trend: 'down',
      indicators: {
        supertrend_direction: 'down',
        ema_9: 18596,
  ...
  opening_range_box_fade_long: {
    fixture_id: 'fixture_opening_range_box_fade_long',
    strategy_id: 'opening_range_box_fade_long',
    description: 'A post-box bar poked below the box low then price reclaimed inside for a false-breakdown long fade.',
    expected_direction: 'long',
    expected_gate_state: 'armed',
    expected_reason_fragments: ['armed', 'mode_fade', 'box_fade_poke_ticks'],
    snapshot: makeSnapshot({
      fixtureId: 'fixture_opening_range_box_fade_long',
      sourceEventId: 'source-bar-opening-range-box-fade-long',
      createdOffsetNs: 19n * 60_000_000_000n,
      direction: 'long',
      bidPx: 18596.875,
      askPx: 18597.125,
      lastTradePrice: 18597,
      barsStartClose: 18596,
      trend: 'range',
      indicators: {
        supertrend_direction: 'up',
  ...
  opening_range_box_fade_short: {
    fixture_id: 'fixture_opening_range_box_fade_short',
    strategy_id: 'opening_range_box_fade_short',
    description: 'A post-box bar poked above the box high then price fell back inside for a false-breakout short fade.',
    expected_direction: 'short',
    expected_gate_state: 'armed',
    expected_reason_fragments: ['armed', 'mode_fade', 'box_fade_poke_ticks'],
    snapshot: makeSnapshot({
      fixtureId: 'fixture_opening_range_box_fade_short',
      sourceEventId: 'source-bar-opening-range-box-fade-short',
      createdOffsetNs: 20n * 60_000_000_000n,
      direction: 'short',
      bidPx: 18597.875,
      askPx: 18598.125,
      lastTradePrice: 18598,
      barsStartClose: 18599,
      trend: 'range',
      indicators: {
        supertrend_direction: 'down',
        ema_9: 18598,
  ...
  opening_range_box_regime_long: {
    fixture_id: 'fixture_opening_range_box_regime_long',
    strategy_id: 'opening_range_box_regime_long',
    description: 'Trending tape (ADX >= trend min) routes the long regime dispatcher to box breakout logic.',
    expected_direction: 'long',
    expected_gate_state: 'armed',
    expected_reason_fragments: ['armed', 'mode_breakout', 'box_breakout_distance_ticks'],
    snapshot: makeSnapshot({
      fixtureId: 'fixture_opening_range_box_regime_long',
      sourceEventId: 'source-bar-opening-range-box-regime-long',
      createdOffsetNs: 21n * 60_000_000_000n,
      direction: 'long',
      bidPx: 18600.875,
      askPx: 18601.125,
      lastTradePrice: 18601,
  ...
  opening_range_box_regime_short: {
    fixture_id: 'fixture_opening_range_box_regime_short',
    strategy_id: 'opening_range_box_regime_short',
    description: 'Trending tape (ADX >= trend min) routes the short regime dispatcher to box breakout logic.',
    expected_direction: 'short',
    expected_gate_state: 'armed',
    expected_reason_fragments: ['armed', 'mode_breakout', 'box_breakout_distance_ticks'],
    snapshot: makeSnapshot({
      fixtureId: 'fixture_opening_range_box_regime_short',
      sourceEventId: 'source-bar-opening-range-box-regime-short',
      createdOffsetNs: 22n * 60_000_000_000n,
      direction: 'short',
      bidPx: 18593.875,
      askPx: 18594.125,
      lastTradePrice: 18594,
...
export function listSyntheticStrategyFixtures(): readonly SyntheticStrategyFixture[] {
  return [
    ...
    STRATEGY_SYNTHETIC_FIXTURES.opening_range_box_breakout_long,
    STRATEGY_SYNTHETIC_FIXTURES.opening_range_box_breakout_short,
    STRATEGY_SYNTHETIC_FIXTURES.opening_range_box_fade_long,
    STRATEGY_SYNTHETIC_FIXTURES.opening_range_box_fade_short,
    STRATEGY_SYNTHETIC_FIXTURES.opening_range_box_regime_long,
    STRATEGY_SYNTHETIC_FIXTURES.opening_range_box_regime_short,
  ];
}
