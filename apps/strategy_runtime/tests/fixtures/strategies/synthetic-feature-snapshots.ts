...
export const STRATEGY_SYNTHETIC_FIXTURES = {
  ...
  regime_shock_reversion_short_v4_delay: {
    ...
    description: 'High-regime upside shock with producer-owned delay confirmation for the inactive v4 delay hypothesis.',
    expected_direction: 'short',
    expected_gate_state: 'armed',
    expected_reason_fragments: ['regime_high', 'signed_shock_vwap', 'delay', 'armed'],
    snapshot: makeSnapshot({
      fixtureId: 'fixture_regime_shock_reversion_short_v4_delay',
      sourceEventId: 'source-bar-regime-shock-reversion-short-v4-delay',
      ...
      context: {
        ...
        signed_shock_vwap_recent_values: [1.5, 2.25, 2.5],
      },
    }),
  },
  regime_shock_reversion_short_v4_persist: {
    fixture_id: 'fixture_regime_shock_reversion_short_v4_persist',
    strategy_id: 'regime_shock_reversion_short_v4_persist',
    description: 'High-regime upside shock with producer-owned persistence confirmation for the inactive v4 persistence hypothesis.',
    expected_direction: 'short',
    expected_gate_state: 'armed',
    expected_reason_fragments: ['regime_high', 'signed_shock_vwap', 'persist', 'armed'],
    snapshot: makeSnapshot({
      fixtureId: 'fixture_regime_shock_reversion_short_v4_persist',
      sourceEventId: 'source-bar-regime-shock-reversion-short-v4-persist',
      ...
      context: {
        ...
        signed_shock_vwap_recent_values: [2.1, 2.25, 2.5],
      },
    }),
  },  regime_shock_reversion_short_v5_strict_deadline: {
    fixture_id: 'fixture_regime_shock_reversion_short_v5_strict_deadline',
    ...
    expected_reason_fragments: ['regime_high', 'signed_shock_vwap', 'armed'],
    snapshot: makeSnapshot({
      fixtureId: 'fixture_regime_shock_reversion_short_v5_strict_deadline',
      sourceEventId: 'source-bar-regime-shock-reversion-short-v2',
      createdOffsetNs: 18n * 60_000_000_000n,
      direction: 'short',
      bidPx: 18614.875,
  ...
  regime_shock_reversion_short_v5_trail_at_deadline: {
    fixture_id: 'fixture_regime_shock_reversion_short_v5_trail_at_deadline',
    ...
    expected_reason_fragments: ['regime_high', 'signed_shock_vwap', 'armed'],
    snapshot: makeSnapshot({
      fixtureId: 'fixture_regime_shock_reversion_short_v5_trail_at_deadline',
      sourceEventId: 'source-bar-regime-shock-reversion-short-v2',
      createdOffsetNs: 19n * 60_000_000_000n,
      direction: 'short',
      bidPx: 18614.875,
